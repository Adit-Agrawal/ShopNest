...
import Img21 from "../img/products/Comp1.jpg";
...
import Comp2 from "../img/products/otherProducts/Comp2.jpg";
import Comp3 from "../img/products/otherProducts/Comp3.avif";
...
export const items = [
  ...
  },
  {
    ...
    category: "chair",
    img: Img1,
    description: "Fur Chair",
    price: 15000,
    otherImgs: [OtherImgs1, OtherImgs2],
    specs:
      "Experience ultimate relaxation with this plush fur chair, designed for comfort and style in any living space. Its luxurious, soft fur and ergonomic design make it the perfect spot to unwind.",
    texture: "Fur",
    weight: "15kg",
    size: "150cm x 70cm",
    boughtQty: 0
  ...
  },
  {
    ...
    price: 150000,
    otherImgs: [Comp2, Comp3],
    specs:
      "Unleash your creativity with the MacBook Pro—power, precision, and performance in every detail. Elevate your work to new heights.",
    texture: "Metal",
    weight: "1.2kg",
    size: "14 inch",
    boughtQty: 0
